...
<div class='center1' ><p style='font-size:20px;'>PRASHNOTTAR TEST PORTAL
<button id='profile' style='float:right;margin-top:3px;'>username</button></p>
...
echo"<p style='font-size:25px;color:white;text-align:center;line-height:10px;font-family:'Courier New';>Hello! $username</p>";
?></a>
...
<p style='font-size:15px;color:white;text-align:center;line-height:none;'><a href = "exam1.php" style="color:white;background-color:transparent;border:0px;top:0;">Logout</a></p>
<hr style="border: 0;
    height: 1px;
...
<p>
	<button id ='all' class='ans11' style='color:Black;border:2px solid black;'>Q</button>Anserwed
	<button id ='all' class='notans1' style='color:Black;margin-left:20px;border:2px solid black;'>Q</button>Unanserwed<br>
	<button id ='all' class='rev1' style='color:Black;margin-left:50px;border:2px solid black;'>Q</button>Marked for Review
</p>
</div></a>
...
<div class="timer">
	<div class='timer1'>
	<p id="demo" style="float:right; color:white;margin-right:10px;margin-top:10px;" ></p>
	<?php echo "<p id=\"demo33\" style=\"float:left; color:white;margin-left:10px;margin-top:10px;font-size:20px;\">$examname</p><br><br>"; 
	?>
	<div class="top">
<?php
//echo"<input type=\"button\" id=\"top2\" value=\"$examname\"/>";
$a = "Hello_$username";
echo"<input type=\"button\" style='color:white;border:none;background-color:transparent;margin-top:-40px;text-align:center;margin-left:40%' id=\"top199\" class = \"btn btn-primary dropdown-toggle\" data-toggle = \"dropdown\" value=$a>";
?>
	<div id="overlay">
		<div id="text">
			<p class="rull" style="text-align:center;">PLEASE READ THE RULES CAREFULLY!!</p>
...
var countDownDate = new Date(date2+" "+rtime).getTime();
...
<div class ="questions">
	...
	<button id ='all' class='ans11' style='color:Black'>Q</button>Anserwed
	<button id ='all' class='notans1' style='color:Black'>Q</button>Not Anserwed
	<button id ='all' class='rev1' style='color:Black'>Q</button>Review
</p>
	</div>
</div>
